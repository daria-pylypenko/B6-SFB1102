...
Ngram bag of POS | 5 | Ngram bag of POS | Example: 1,2 or 1,2,1,c:\taggedInput.txt  (Uni-grams that appear at least twice) <li> N in ngram </li> <li> Cutoff frequency </li> <li> Flag indicating given POS tag input </li> <li> Tagged POS input (Optional) </li>
